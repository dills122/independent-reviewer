...
| FO-3I | #148 | Register adapters in canonical repository capture and prove shared-node merge | lead | FO-3A, FO-3B | Combined discovery corpus passes; multi-family content renders once with full provenance | Implemented; provider-free gate green, independent review pending |
...
Latest provider-free gate (2026-09-13): formatting, lint, typecheck, 543
coverage tests, and 30 E2E tests pass under Node.js 24. Dependency audit reports
