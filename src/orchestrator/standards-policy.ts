...
export function assertStandardsRuleCoverage(
  ...
  for (const entry of entries.values()) {
    if (entry.status === "ASSESSED" && entry.conflictingRuleIds.length)
